...
const AddUserForm = ({ setAlert, setIsAddClicked, isAddClicked, dataEntry = false }) => {
    ...
    return (
        <div className="fixed inset-0 pt-20 pb-6 flex justify-center  bg-gray-500 bg-opacity-50 z-[100] backdrop-blur-md backdrop-filter" >
            <div className="bg-white rounded-3xl p-4 pb-10 w-[80vw] sm:w-3/4 h-fit  relative custom-shadow">
                ...
                <h2 className="mb-4 3xl:text-4xl text-2xl">Add User</h2>
                <div>
                    <div className='flex 3xl:text-2xl text-black flex-col h-auto px-4  overflow-y-scroll custom-scrollbar' >
                        ...
                        <div className="flex justify-center gap-3">
                            ...
                            <input className='bg-[#1c75bc]   disabled:cursor-not-allowed text-white p-2 w-1/3 self-end rounded-full my-3 hover:bg-blue-400' type="submit" disabled={values.name == '' > 0 ? true : false} value="Submit" onClick={() => handleAddEntry(false)} />

                            <input className='bg-[#1c75bc]  disabled:cursor-not-allowed text-white p-2 w-1/3 self-end rounded-full my-3 hover:bg-blue-400' type="submit" disabled={values.name == '' > 0 ? true : false} value="Submit & Add More" onClick={() => handleAddEntry(true)} />
                        </div>
                    </div>
                </div>
            </div>
