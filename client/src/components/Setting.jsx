                    ...
                    {employeeTypeClick &&
                        <>
                            <div className="flex justify-end">
                                ...
                                <button className='bg-blue-500  px-3 py-2 hover:bg-blue-400 text-white rounded-full mb-4 ' onClick={() => setClickAdd2(!clickAdd2)}>Add New</button>
                            </div>
                            <div className="flex justify-center">
                    ...
                    {templateClick &&
                        <>
                            <div className="flex justify-end">
                                ...
                                <button className='bg-blue-500  px-3 py-2 hover:bg-blue-400 text-white rounded-full mb-4 ' onClick={() => setClickAdd3(!clickAdd3)}>Add New</button>
                            </div>
                            <div className="flex justify-center">
                    ...
                    <div className="fixed inset-0 pt-[30vh] pb-6 flex justify-center  bg-gray-500 bg-opacity-50 z-20">
                        <div className="bg-white  rounded-lg p-4 w-screen mx-5 h-fit sm:w-1/2 relative custom-shadow">
                            ...
                            <div className="self-end w-full flex justify-center">
                                <button className='bg-blue-500 px-3 py-2 w-1/2 mt-3 hover:bg-blue-400 text-white rounded-full ' onClick={handleAdd}>Add</button>
                            </div>
                        </div>
                    </div>
                ...
                {clickAdd2 &&
                    <div className="fixed inset-0 pt-[30vh] pb-6 flex justify-center  bg-gray-500 bg-opacity-50 z-20">
                        <div className="bg-white  rounded-lg p-4 w-screen mx-5 h-fit sm:w-1/2 relative custom-shadow">
                            ...
                            <div className="self-end w-full flex justify-center">
                                <button className='bg-blue-500 px-3 py-2 w-1/2 mt-3 hover:bg-blue-400 text-white rounded-full ' onClick={handleAddEmployee}>Add</button>
                            </div>
                        </div>
                    </div>
                ...
                {clickAdd3 &&
                    <div className="fixed inset-0 pt-[30vh] pb-6 flex justify-center  bg-gray-500 bg-opacity-50 z-20 ">
                        <div className="bg-white  rounded-lg p-4 w-screen mx-5 h-fit sm:w-1/2 relative custom-shadow" >
                            ...
                            <div className="self-end w-full flex justify-center">
                                <button className='bg-blue-500 px-3 py-2 w-1/2 mt-3 hover:bg-blue-400 text-white rounded-full ' onClick={handleAddTemplate}>Add</button>
                            </div>
                        </div>
                    </div>
