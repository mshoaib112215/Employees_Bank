    ...
    return (
        <div className="w-full">
            <h1 className='text-2xl font-semibold mt-5'>
                Welcome {thisUser?.name}!
            </h1>
            <h1 className='text-[16px] font-semibold text-gray-600  mt-1 mb-7'>
                Dashboard
            </h1>
            <div className="flex justify-evenly sm:flex-row flex-col gap-7 ">
                ...
                <div className='flex-1 flex flex-col items-center custom-shadow p-6 pt-3 h-32 text-lg md:text-2xl sm:text-xl border-none rounded-3xl  bg-white font-semibold'>
                    ...
                    {isLoading ?
                        ...
                        :
                        (
                            <div className='text-5xl flex items-center w-full justify-between md:text-7xl self-center sm:text-3xl font-semibold font-mono'>
            ...
            <div className='flex gap-3 items-start w-full h-[35rem] mb-8'>
                <div className='flex-1 h-full bg-white rounded-xl flex flex-col items-center justify-center p-5 mt-10 custom-shadow'>

                    <h2 className='text-xl sm:text-3xl font-semibold mt-3'>Employee Data Entries by Month</h2>
                ...
                <div className='flex-1 h-full bg-white rounded-xl flex flex-col items-center justify-center p-5 mt-10 custom-shadow'>
                    ...
                    <h2 className='text-xl sm:text-3xl font-semibold mt-3 '>Employee Categories Distribution</h2>
                    <div className='flex-1 h-auto w-full overflow-y-scroll custom-scrollbar'>
                    ...
                    <table className="min-w-full whitespace-nowrap text-[15px] text-left">
                        ...
                        {isLoading ? ( // Step 3: Conditionally render loader or content
                            <td colSpan="12"><Loader /></td> // Use your loader component here
                                ...
                                <tbody className="bg-white divide-y divide-gray-200 text-[15px] text-left">
